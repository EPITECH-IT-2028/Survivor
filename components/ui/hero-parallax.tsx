...
export const Header = () => {
  return (
    <div className="relative top-0 left-0 mx-auto w-full max-w-7xl px-4 py-20 md:py-40">
      <h1 className="font-montserrat text-4xl font-bold md:text-7xl dark:text-white">
        JEB Incubator.
      </h1>
      <p className="mt-8 max-w-2xl text-base md:text-xl dark:text-neutral-200">
        Where <strong className="text-primary">ideas</strong> become startups, and startups become <strong className="text-primary">success</strong>.
      </p>
    </div>
  );
};
